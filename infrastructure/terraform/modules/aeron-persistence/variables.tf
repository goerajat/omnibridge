# =============================================================================
# OmniBridge Aeron Persistence Module - Variables
# =============================================================================
...
variable "instance_type" {
  description = "EC2 instance type. t3.large recommended for persistence workloads."
  type        = string
  default     = "t3.large"
}
...
variable "engine_host" {
  description = "Private IP of the trading engine for Aeron replay responses"
  type        = string
}

variable "publisher_id" {
  description = "Publisher ID for the Aeron remote store (matches engine publisher-id)"
  type        = number
  default     = 1
}
