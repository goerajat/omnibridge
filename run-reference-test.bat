...
start "" /b java -jar "%ACCEPTOR_JAR%" -c "%CONFIG_DIR%\acceptor.conf" > acceptor-ref-test.log 2>&1
...
echo ==========================================================================
echo.
java -jar "%TESTER_JAR%" test --host localhost --port 9876 --sender CLIENT --target EXCHANGE --tests %TESTS%
