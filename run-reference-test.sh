...
ACCEPTOR_JAR="fix-sample-apps/target/fix-sample-apps-1.0.0-SNAPSHOT-all.jar"
TESTER_JAR="fix-reference-tester/target/fix-reference-tester-1.0.0-SNAPSHOT-all.jar"
