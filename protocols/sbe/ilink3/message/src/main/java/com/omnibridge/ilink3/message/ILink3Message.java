...
/**
 * Base class for all CME iLink 3 messages.
 * <p>
 * iLink 3 uses SBE (Simple Binary Encoding) with:
 * <ul>
 *   <li>Schema ID: 8</li>
 *   <li>Schema Version: 9</li>
 ...
 * 4       2       Template ID
 * 6       2       Schema ID (8)
 * 8       2       Schema Version (9)
 * 10      var     Message Body
 * </pre>
 */
public abstract class ILink3Message extends SbeMessage {

    /** CME iLink 3 schema ID */
    public static final int SCHEMA_ID = 8;

    /** CME iLink 3 schema version */
    ...
    /**
     * Gets the message type for this iLink 3 message.
     *
     * @return the message type
     */
    @Override
    public abstract ILink3MessageType getMessageType();
