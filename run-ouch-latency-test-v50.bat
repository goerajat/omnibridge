...
echo.
java %JVM_OPTS% -cp "%UBER_JAR%" com.fixengine.apps.ouch.initiator.SampleOuchInitiator -c ouch-initiator-v50.conf --latency --warmup-orders %WARMUP_ORDERS% --test-orders %TEST_ORDERS% --rate %RATE%
