...
/**
 * Factory for creating and reading Optiq messages.
 */
public class OptiqMessageFactory implements SbeMessageFactory {

    private static final ThreadLocal<OptiqMessagePool> POOL =
            ThreadLocal.withInitial(OptiqMessagePool::new);

    private static final ThreadLocal<OptiqMessageReader> READER =
            ThreadLocal.withInitial(OptiqMessageReader::new);
